...
function Page() {
    ...
    const handleSubmit1 = (e)=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.post("http://localhost:8080/user/signin", {
            email,
            password
        }, {
            headers
...
function Page() {
    ...
    const handleSubmit = (e)=>{
        ...
        axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.post("http://localhost:8080/user/signup", {
            name,
            email,
            password
        }, {
